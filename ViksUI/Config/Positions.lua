...
C["position"] = {
	...
	-- UnitFrame positions
	unitframes = {
		["player"] = C.layout2.enable and {"TOPRIGHT", "Layout2_ReferencePoint", "TOPRIGHT", -50, 0} or {"BOTTOMRIGHT", "ActionBarAnchor", "TOPLEFT", -9, 175},
		["target"] = C.layout2.enable and {"TOPLEFT", "Layout2_ReferencePoint", "TOPLEFT", 50, 0} or {"BOTTOMLEFT", "ActionBarAnchor", "TOPRIGHT", 9, 175},
		["target_target"] = C.layout2.enable and {"TOP", "Layout2_ReferencePoint", "BOTTOM", 0, -86} or {"TOPRIGHT", "oUF_Target", "BOTTOMRIGHT", 0, -11},
		["pet"] = C.layout2.enable and {"CENTER", "Layout2_ReferencePoint", "CENTER", 0, 0} or {"TOPLEFT", "oUF_Player", "BOTTOMLEFT", 0, -11},
		["focus"] = {"TOPRIGHT", "oUF_Player", "BOTTOMRIGHT", 0, -11},				-- Focus frame
		["focus_target"] = {"TOPLEFT", "oUF_Target", "BOTTOMLEFT", 0, -11},			-- Focus target frame
		["party_heal"] = C.layout2.enable and {"TOPLEFT", UIParent, "TOPLEFT", 50, -100} or {"TOPLEFT", "oUF_Player", "BOTTOMRIGHT", 11, -12},
		["raid_heal"] = C.layout2.enable and {"TOPLEFT", UIParent, "TOPLEFT", 50, -50} or {"TOPLEFT", "oUF_Player", "BOTTOMRIGHT", 11, -12},
		...
		["player_portrait"] = C.layout2.enable and {"TOPLEFT", "oUF_Player", "TOPRIGHT", 38, 2} or {"TOPRIGHT", "oUF_Player", "TOPLEFT", -12, 27},
		["target_portrait"] = C.layout2.enable and {"TOPRIGHT", "oUF_Target", "TOPLEFT", -10, 2} or {"TOPLEFT", "oUF_Target", "TOPRIGHT", 12, 27},
